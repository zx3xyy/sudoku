...
- **Expert** mode requires advanced logic such as locked candidates and naked pairs, without blind guessing
- **Extreme** mode keeps the legendary, genuinely brutal puzzles for an optional final tier
